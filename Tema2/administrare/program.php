...
<body>
    ...
    <h3>Gestionarea programului</h3>

    <form action="programinsert.php" method="POST">
        <div class="input-group flex-nowrap">
            <input type="text" name="List" class="form-control" placeholder="Introduceti informatiile" aria-label="Introduceti informatiile" aria-describedby="addon-wrapping">
    ...
    <?php
        ...
        $rawData = mysqli_query($conn, "select * from program");
    ?>
            ...
            <table class="table">
                ...
                ?>
                    <tr>
                        ...
                        <td style="width: 10%;"><a href="programdelete.php? ID=<?php echo $row['Id'] ?>" class="btn btn-danger">STERGE</a></td>
                        <td style="width: 10%;"><a href="programupdate.php? ID=<?php echo $row['Id'] ?>" class="btn btn-success">EDITEAZA</a></td>
                    </tr>
                    <?php
                    }
                    ?>
